...
void Phall::Price()
{
	cout << "Выбран премиальный зал!Цена за билет:500 рублей!" << endl;
}

bool Phall::set_and_check_Place(int i, int j)
{
	if (m_place[i][j] == true)
	{
		return false;
...
string Phall::set_get_movie(int i) 
{
	m_movie[0] = "1+1";
	m_movie[1] = "Паразиты";
...
string Phall::set_get_time(int i)
{
